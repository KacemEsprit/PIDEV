...
class getConsole_Command_PublicAlias_Flasher_InstallCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'php-flasher'.\DIRECTORY_SEPARATOR.'flasher-symfony'.\DIRECTORY_SEPARATOR.'Bridge'.\DIRECTORY_SEPARATOR.'Typed'.\DIRECTORY_SEPARATOR.'Command'.\DIRECTORY_SEPARATOR.'FlasherCommand.php';
