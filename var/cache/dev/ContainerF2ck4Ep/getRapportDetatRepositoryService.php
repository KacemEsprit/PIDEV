 ...
 */
class getRapportDetatRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RapportDetatRepository' shared autowired service.
     *
     * @return \App\Repository\RapportDetatRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RapportDetatRepository.php';

        return $container->privates['App\\Repository\\RapportDetatRepository'] = new \App\Repository\RapportDetatRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
