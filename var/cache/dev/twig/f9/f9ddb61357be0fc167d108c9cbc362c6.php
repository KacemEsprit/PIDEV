...
class __TwigTemplate_8eb74483860cc8a2f0951c059d9e30ee extends Template
{
...
<div class=\"container py-5\">
  ...
  ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["patient"]) {
            // line 187
            yield "
    <a href=\"#\" class=\"list-group-item patient-item\" data-patient-id=\"";
            // line 188
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["patient"], "id", [], "any", false, false, false, 188), "html", null, true);
            yield "\">
      <div class=\"d-flex align-items-center\">
        ...
        <div>
          <h6 class=\"mb-0\">";
            // line 195
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["patient"], "nom", [], "any", false, false, false, 195), "html", null, true);
            yield " ";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["patient"], "prenom", [], "any", false, false, false, 195), "html", null, true);
            yield "</h6>
          <small class=\"text-muted\">";
            // line 196
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["patient"], "adresse", [], "any", false, false, false, 196), "html", null, true);
            yield "</small>
        </div>
      </div>
    </a>
...
";
        // line 452
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["rapports"]) || array_key_exists("rapports", $context) ? $context["rapports"] : (function () { throw new RuntimeError('Variable "rapports" does not exist.', 452, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["rapport"]) {
            // line 453
            yield "  <div id=\"report";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["rapport"], "id", [], "any", false, false, false, 453), "html", null, true);
            yield "\" class=\"report-content report-card\" style=\"display: none;\" data-patient-id=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["rapport"], "patient", [], "any", false, false, false, 453), "id", [], "any", false, false, false, 453), "html", null, true);
            yield "\" data-date=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, $context["rapport"], "dateRapport", [], "any", false, false, false, 453), "d/m/Y"), "html", null, true);
            yield "\">
    <div class=\"report-header\">
      <div class=\"d-flex justify-content-between align-items-center\">
        <h2>Rapport Médical de ";
            // line 456
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["rapport"], "patient", [], "any", false, false, false, 456), "nom", [], "any", false, false, false, 456), "html", null, true);
            yield " ";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["rapport"], "patient", [], "any", false, false, false, 456), "prenom", [], "any", false, false, false, 456), "html", null, true);
            yield "</h2>
        <div class=\"report-actions\">
          <a href=\"#\" class=\"btn btn-primary\" onclick=\"ouvrirModalEdition(";
            // line 458
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["rapport"], "id", [], "any", false, false, false, 458), "html", null, true);
            yield ")\">
            <i class=\"fas fa-edit\"></i> Modifier
          </a>
          <button type=\"button\" class=\"btn btn-danger ms-2\" onclick=\"confirmerSuppression(";
            // line 461
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["rapport"], "id", [], "any", false, false, false, 461), "html", null, true);
            yield ")\">
    ...
    <div class=\"report-body\">
      <p><strong>Âge :</strong> ";
            // line 469
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["rapport"], "age", [], "any", false, false, false, 469), "html", null, true);
            yield "</p>
      <p><strong>Sexe :</strong> ";
            // line 470
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["rapport"], "sexe", [], "any", false, false, false, 470), "html", null, true);
            yield "</p>
      <p><strong>Date du Rapport :</strong> ";
            // line 471
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, $context["rapport"], "dateRapport", [], "any", false, false, false, 471), "d/m/Y"), "html", null, true);
            yield "</p>
      <p><strong>Tension Artérielle :</strong> ";
            // line 472
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["rapport"], "tensionArterielle", [], "any", false, false, false, 472), "html", null, true);
            yield "</p>
      <p><strong>Pouls :</strong> ";
            // line 473
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["rapport"], "pouls", [], "any", false, false, false, 473), "html", null, true);
            yield "</p>
      <p><strong>Température :</strong> ";
            // line 474
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["rapport"], "temperature", [], "any", false, false, false, 474), "html", null, true);
            yield "°C</p>
      <p><strong>Saturation en Oxygène :</strong> ";
            // line 475
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["rapport"], "saturationOxygene", [], "any", false, false, false, 475), "html", null, true);
            yield "%</p>
      <p><strong>IMC :</strong> ";
            // line 476
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["rapport"], "imc", [], "any", false, false, false, 476), "html", null, true);
            yield "</p>
      <p><strong>Niveau de Douleur :</strong> ";
            // line 477
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["rapport"], "niveauDouleur", [], "any", false, false, false, 477), "html", null, true);
            yield "</p>
      <p><strong>Traitement :</strong> ";
            // line 478
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["rapport"], "traitement", [], "any", false, false, false, 478), "html", null, true);
            yield "</p>
      <p><strong>Complications :</strong> ";
            // line 479
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((CoreExtension::getAttribute($this->env, $this->source, $context["rapport"], "complications", [], "any", true, true, false, 479)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, $context["rapport"], "complications", [], "any", false, false, false, 479), "Aucune")) : ("Aucune")), "html", null, true);
            yield "</p>
    </div>
  </div>
";
...
";
    ...
    {
        return array (  715 => 483,  705 => 479,  701 => 478,  697 => 477,  693 => 476,  689 => 475,  685 => 474,  681 => 473,  677 => 472,  673 => 471,  669 => 470,  665 => 469,  654 => 461,  648 => 458,  641 => 456,  630 => 453,  626 => 452,  600 => 429,  524 => 356,  367 => 201,  356 => 196,  350 => 195,  340 => 188,  337 => 187,  333 => 186,  314 => 170,  162 => 20,  149 => 19,  132 => 13,  119 => 12,  102 => 6,  89 => 5,  66 => 3,  43 => 1,);
    }
