...
{
    /**
     * Gets the private '.debug.security.voter.App\Security\Voter\CommentVoter' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Security'.\DIRECTORY_SEPARATOR.'Voter'.\DIRECTORY_SEPARATOR.'CommentVoter.php';

        $a = ($container->privates['security.helper'] ?? $container->load('getSecurity_HelperService'));

        if (isset($container->privates['.debug.security.voter.App\\Security\\Voter\\CommentVoter'])) {
            return $container->privates['.debug.security.voter.App\\Security\\Voter\\CommentVoter'];
        }
        ...
        return $container->privates['.debug.security.voter.App\\Security\\Voter\\CommentVoter'] = new \Symfony\Component\Security\Core\Authorization\Voter\TraceableVoter(new \App\Security\Voter\CommentVoter($a), $b);
    }
}
