 ...
 */
final class Version20250215224526 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE compagnie (id INT AUTO_INCREMENT NOT NULL, donateur_id INT NOT NULL, nom VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, telephone VARCHAR(20) NOT NULL, email VARCHAR(255) NOT NULL, site_web VARCHAR(255) NOT NULL, siret VARCHAR(14) NOT NULL, description LONGTEXT DEFAULT NULL, logo VARCHAR(255) DEFAULT NULL, date_creation DATETIME NOT NULL, statut_juridique VARCHAR(100) NOT NULL, statut_validation VARCHAR(20) NOT NULL, motif_rejet LONGTEXT DEFAULT NULL, UNIQUE INDEX UNIQ_A26209686C6E55B5 (nom), UNIQUE INDEX UNIQ_A262096826E94372 (siret), INDEX IDX_A2620968A9C80E3 (donateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
