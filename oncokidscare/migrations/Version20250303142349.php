 ...
 */
final class Version20250303142349 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, patient_id INT NOT NULL, status VARCHAR(255) NOT NULL, date_commande DATETIME NOT NULL, quantite_total INT NOT NULL, montant_total DOUBLE PRECISION NOT NULL, rate INT DEFAULT NULL, INDEX IDX_6EEAA67D6B899279 (patient_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, publication_id INT NOT NULL, user_id INT NOT NULL, contenu_com VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', voice_url VARCHAR(255) DEFAULT NULL, type VARCHAR(20) NOT NULL, duration INT DEFAULT NULL, reported TINYINT(1) DEFAULT 0 NOT NULL, report_reason VARCHAR(50) DEFAULT NULL, INDEX IDX_9474526C38B217A7 (publication_id), INDEX IDX_9474526CA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
