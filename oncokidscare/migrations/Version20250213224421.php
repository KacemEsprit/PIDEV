 ...
 */
final class Version20250213224421 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD telephone VARCHAR(20) DEFAULT NULL, ADD donateur_type VARCHAR(20) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP telephone, DROP donateur_type');
    }
}
