 ...
 */
final class Version20250209220714 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE don (id INT AUTO_INCREMENT NOT NULL, donateur_id INT NOT NULL, compagnie_id INT DEFAULT NULL, campagne_id INT DEFAULT NULL, type_don VARCHAR(50) NOT NULL, montant NUMERIC(10, 2) DEFAULT NULL, description_materiel LONGTEXT DEFAULT NULL, date_don DATETIME NOT NULL, statut VARCHAR(50) NOT NULL, mode_paiement VARCHAR(50) NOT NULL, preuve_don VARCHAR(255) DEFAULT NULL, INDEX IDX_F8F081D9A9C80E3 (donateur_id), INDEX IDX_F8F081D952FBE437 (compagnie_id), INDEX IDX_F8F081D916227374 (campagne_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
